...
exports.toModel = (entity) => {
  ...
  let model = {
    ...
    isParentJoin: entity.isParentJoin,
    privateOrGroup: entity.privateOrGroup,
    maxTravelDistance: entity.maxTravelDistance,
    instructor: entity.instructor,
    totalSessionClasses: entity.totalSessionClasses,
    offerDiscount: entity.offerDiscount,
    isParentGuardianRequire: entity.isParentGuardianRequire,
